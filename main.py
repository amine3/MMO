...
class RPG:
    ...
    def Atk(self, i):
        ...
        if self.MapTest.mobs[i].hp <= 0:
            ...
            self.MapTest.mobs[i].hprect = pygame.Rect((0, 0),
                                                      (self.MapTest.mobs[i].hp * 28.0 / self.MapTest.mobs[i].maxhp, 3))
    ...
    def ActivateSpell(self):
        ...
        if mob_ind:
            ...
            if self.MapTest.mobs[mob_ind].hp <= 0:
                ...
                self.MapTest.mobs[mob_ind].hprect = pygame.Rect((0, 0), (
                self.MapTest.mobs[mob_ind].hp * 28.0 / self.MapTest.mobs[mob_ind].maxhp, 3))
    ...
    def MobKill(self, i):
        ...
        self.I.FastSurfaces.append(
            FastSurface(text="+" + str(self.MapTest.mobs[i].nivel) + " Souls", size=11, color=(10, 10, 200),
                        left=self.I.jugador.rect.left + 7, top=self.I.jugador.rect.top - 20, retard=40))
        self.I.FastSurfaces.append(
            FastSurface(text="+" + str(self.MapTest.mobs[i].exp) + " EXP", size=11, color=(10, 10, 200),
                        left=self.I.jugador.rect.left + 7, top=self.I.jugador.rect.top - 20, retard=20))
    ...
    def DamageFastSurface(self, i, spell_damage=None):
        ...
        if damage > 0:
            self.I.FastSurfaces.append(
                FastSurface(text="-" + str(damage), color=(225, 0, 0), left=self.MapTest.mobs[i].rect.left + 7,
                            top=self.MapTest.mobs[i].rect.top - 20))
        else:
            self.I.FastSurfaces.append(
                FastSurface(text="Resistido", color=(225, 0, 0), left=self.MapTest.mobs[i].rect.left + 7,
                            top=self.MapTest.mobs[i].rect.top - 20))
